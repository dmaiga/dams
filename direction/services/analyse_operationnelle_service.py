...
class AnalyseOperationnelleService:
    ...
    def analyser(date_debut, date_fin, agent_id=None, produit_id=None):
        ...
        kpis = qs.aggregate(
            ...
            total_kg=Coalesce(Sum('kg'), Decimal('0.00')),
            total_ca=Coalesce(Sum('ca'), Decimal('0.00')),
            total_marge=Coalesce(Sum('marge'), Decimal('0.00')),
        ...
        recap_produits = (
            ...
            .annotate(
                ...
                kg_vendus=Coalesce(Sum('kg'), Decimal('0.00')),
                ca=Coalesce(Sum('ca'), Decimal('0.00')),
                marge=Coalesce(Sum('marge'), Decimal('0.00')),
            )
            .order_by('-quantite')
        )
